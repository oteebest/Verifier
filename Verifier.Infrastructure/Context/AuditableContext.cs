...
using Verifier.Domain.Audit;
using Verifier.Domain.Entities.User;

namespace Infrastructure.Contexts
{
    public abstract class AuditableContext : IdentityDbContext<VerifierUser, VerifierRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, VerifierRoleClaim, IdentityUserToken<string>>
    {
